...
export default function Navbar() {
  return (
    <header
      className="py-6 fixed top-0 z-10 bg-secondary/20 backdrop-blur-md w-full border-b-1 
          border-1 border-accent/30 "
    >
      <nav className="flex flex-row gap-8 w-[75vw] mx-auto opacity-100 hover:[&>*]:opacity-80 hover:[&>*]:after:scale-x-0 transition-opacity">
